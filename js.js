...
formLayoutEnter.onclick = function(){
    if(inputs[0].value === "bdfso" && inputs[1].value === "02122001"){
...
const block7Icon = $('.block7-icon')
const block7Layout = $('.block7-layout')
const block7MyVideo = $('.block7-myVideo')

block7Icon.onclick = function(){
    block7Layout.style.opacity = '0'
    block7Icon.style.opacity = '0'
    setTimeout(function(){
        block7Layout.style.display = 'none'
        block7Icon.style.display = 'none'
    },200)
    block7MyVideo.play();
    block7MyVideo.currentTime = 0;
    block7MyVideo.muted = false;

    setTimeout(function(){
        block7Layout.style.opacity = '1'
        block7Icon.style.opacity = '1'
        block7Layout.style.display = 'block'
        block7Icon.style.display = 'block'
    },12000)
}